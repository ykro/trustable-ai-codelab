...
export const SONOMA_TEST_TRACK: Track = {
  ...
  corners: [
    ...
    { id: 10, name: 'Turn 10', entryDist: 2700, apexDist: 2780, exitDist: 2850, lat: 38.16020, lon: -122.45350, advice: 'Stay committed through the kink', entryLat: 38.16040, entryLon: -122.45380, targetSpeed: 95, visualReference: 'Eyes up to the bridge tire mark' },
    { id: 11, name: 'Turn 11', entryDist: 3200, apexDist: 3280, exitDist: 3350, lat: 38.16100, lon: -122.45300, advice: 'Final corner, strong exit onto straight', entryLat: 38.16120, entryLon: -122.45330, targetSpeed: 60, visualReference: 'Eyes up to the start-finish line' },
  ],
  mapPoints: [],
};
